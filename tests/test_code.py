...
def test_filter_of_executed():
    assert filter_of_executed() == [{'id': 441945886, 'state': 'EXECUTED', 'date': '2019-08-26T10:50:58.294041',
                                     'operationAmount': {'amount': '31957.58', 'currency': {'name': 'руб.', 'code':
                                         'RUB'}}, 'description': 'Перевод организации', 'from':
                                         'Maestro 1596837868705199', 'to': 'Счет 64686473678894779589'},
                                    {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364',
                                     'operationAmount': {'amount': '8221.37', 'currency':
                                         {'name': 'USD', 'code': 'USD'}}, 'description': 'Перевод организации',
                                     'from': 'MasterCard 7158300734726758', 'to': 'Счет 35383033474447895560'},
                                    {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572',
                                     'operationAmount': {'amount': '9824.07',
                                                         'currency': {'name': 'USD', 'code': 'USD'}}
                                        , 'description': 'Перевод организации', 'from': 'Счет 75106830613657916952',
                                     'to': 'Счет 11776614605963066702'}, {'id': 587085106, 'state': 'EXECUTED',
                                    'date': '2018-03-23T10:45:06.972075','operationAmount': {'amount': '48223.05',
                                    ...
                                    {'id': 649467725, 'state': 'EXECUTED', 'date': '2018-04-14T19:35:28.978265',
                                     'operationAmount': {'amount': '96995.73',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 782295999, 'state': 'EXECUTED', 'date': '2019-09-11T17:30:34.445824',
                                     'operationAmount': {'amount': '54280.01',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 542678139, 'state': 'EXECUTED', 'date': '2018-10-14T22:27:25.205631',
                                     'operationAmount': {'amount': '90582.51',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 558167602, 'state': 'EXECUTED', 'date': '2019-04-12T17:27:27.896421',
                                     'operationAmount': {'amount': '43861.89',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 536723678, 'state': 'EXECUTED', 'date': '2018-06-12T07:17:01.311610',
                                     'operationAmount': {'amount': '26334.08',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 988276204, 'state': 'EXECUTED', 'date': '2018-02-22T00:40:19.984219',
                                     'operationAmount': {'amount': '71771.90',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 34148726, 'state': 'EXECUTED', 'date': '2018-11-23T23:52:36.999661',
                                     ...
                                     'from': 'Visa Platinum 5355133159258236', 'to': 'Maestro 8045769817179061'},
                                    {'id': 104807525, 'state': 'EXECUTED', 'date': '2019-06-01T06:46:16.803326',
                                     'operationAmount': {'amount': '60888.63',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                     'description': 'Перевод с карты на счет', 'from': 'МИР 8201420097886664',
                                    ...
                                    {'id': 484201274, 'state': 'EXECUTED', 'date': '2019-04-11T23:10:21.514616',
                                     'operationAmount': {'amount': '62621.51',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                     'description': 'Перевод с карты на карту', 'from': 'МИР 8193813157568899',
                                    ...
                                    {'id': 122284694, 'state': 'EXECUTED', 'date': '2019-08-08T21:58:06.688541',
                                     'operationAmount': {'amount': '98657.83',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 743278119, 'state': 'EXECUTED', 'date': '2018-10-15T08:05:34.061711',
                                     'operationAmount': {'amount': '51203.12',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 373912477, 'state': 'EXECUTED', 'date': '2018-03-09T02:11:01.339352',
                                     'operationAmount': {'amount': '33249.01',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 720751477, 'state': 'EXECUTED', 'date': '2018-11-08T08:21:45.902633',
                                     'operationAmount': {'amount': '16872.46',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 949194534, 'state': 'EXECUTED', 'date': '2019-08-15T01:48:10.042554',
                                     'operationAmount': {'amount': '31222.43',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 260972664, 'state': 'EXECUTED', 'date': '2018-01-23T01:48:30.477053',
                                     'operationAmount': {'amount': '2974.30',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 317987878, 'state': 'EXECUTED', 'date': '2018-01-13T13:00:58.458625',
                                     'operationAmount': {'amount': '55985.82',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 72122709, 'state': 'EXECUTED', 'date': '2018-12-18T17:07:09.800800',
                                     'operationAmount': {'amount': '19683.25',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 242885401, 'state': 'EXECUTED', 'date': '2019-07-08T00:08:32.986663',
                                     'operationAmount': {'amount': '10083.68',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 894961746, 'state': 'EXECUTED', 'date': '2019-08-04T20:17:25.443322',
                                     'operationAmount': {'amount': '2523.44',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 360577236, 'state': 'EXECUTED', 'date': '2019-09-07T07:20:13.889610',
                                     'operationAmount': {'amount': '18536.73',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                     'description': 'Перевод с карты на карту', 'from': 'Maestro 4284341727554246',
                                    ...
                                    {'id': 74897425, 'state': 'EXECUTED', 'date': '2019-02-08T09:09:35.038506',
                                     'operationAmount': {'amount': '62654.30',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 636137913, 'state': 'EXECUTED', 'date': '2019-06-16T22:17:01.825020',
                                     'operationAmount': {'amount': '24260.78',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 813238385, 'state': 'EXECUTED', 'date': '2018-05-04T03:29:30.253483',
                                     'operationAmount': {'amount': '22007.02',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 854048120, 'state': 'EXECUTED', 'date': '2019-03-29T10:57:20.635567',
                                     'operationAmount': {'amount': '30234.99',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 431131847, 'state': 'EXECUTED', 'date': '2018-05-05T01:38:56.538074',
                                     'operationAmount': {'amount': '56071.02',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 596914981, 'state': 'EXECUTED', 'date': '2018-04-16T17:34:19.241289',
                                     'operationAmount': {'amount': '65169.27',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 902831954, 'state': 'EXECUTED', 'date': '2018-04-22T17:01:46.885252',
                                     'operationAmount': {'amount': '84732.61',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 232222017, 'state': 'EXECUTED', 'date': '2018-07-06T22:32:10.495465',
                                     'operationAmount': {'amount': '37160.27',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 185048835, 'state': 'EXECUTED', 'date': '2019-05-06T00:17:42.736209',
                                     'operationAmount': {'amount': '74895.83',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 422035015, 'state': 'EXECUTED', 'date': '2019-02-27T03:59:25.921176',
                                     'operationAmount': {'amount': '69311.35',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                    ...
                                    {'id': 917824439, 'state': 'EXECUTED', 'date': '2019-07-18T12:27:13.355343',
                                     'operationAmount': {'amount': '82139.20',
                                                         'currency': {'name': 'руб.', 'code': 'RUB'}},
                                     'description': 'Перевод с карты на карту',
                                     'from': 'Visa Platinum 6942697754917688', 'to': 'МИР 2956603572573342'},
                                    {'id': 736942989, 'state': 'EXECUTED', 'date': '2019-09-06T00:48:01.081967',
                                     'operationAmount': {'amount': '6357.56',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                    ...
                                    {'id': 580054042, 'state': 'EXECUTED', 'date': '2018-06-20T03:59:34.851630',
                                     'operationAmount': {'amount': '96350.51',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                     'description': 'Перевод с карты на счет', 'from': 'МИР 3766446452238784',
                                    ...
                                    {'id': 179194306, 'state': 'EXECUTED', 'date': '2019-05-19T12:51:49.023880',
                                     'operationAmount': {'amount': '6381.58',
                                                         'currency': {'name': 'USD', 'code': 'USD'}},
                                     'description': 'Перевод организации', 'from': 'МИР 5211277418228469',
...
def test_output_5_end_operations():
    assert output_5_end_operations() == [{'id': 863064926, 'state': 'EXECUTED', 'date': '2019-12-08T22:46:21.935582',
                                          'operationAmount': {'amount': '41096.24', 'currency':
                                              {'name': 'USD', 'code': 'USD'}}, 'description': 'Открытие вклада',
                                          'to': 'Счет 90424923579946435907'}, {'id': 114832369, 'state': 'EXECUTED',
                                        'date': '2019-12-07T06:17:14.634890', 'operationAmount': {'amount': '48150.39',
                                        'currency': {'name': 'USD', 'code': 'USD'}}, 'description': 'Перевод организации',
                                        'from': 'Visa Classic 2842878893689012', 'to': 'Счет 35158586384610753655'},
                                         {'id': 154927927, 'state': 'EXECUTED', 'date': '2019-11-19T09:22:25.899614',
                                          ...
                                          'description': 'Перевод организации', 'from': 'Maestro 7810846596785568',
                                          'to': 'Счет 43241152692663622869'}, {'id': 482520625, 'state': 'EXECUTED',
                                        'date': '2019-11-13T17:38:04.800051', 'operationAmount': {'amount': '62814.53',
                                        'currency': {'name': 'руб.', 'code': 'RUB'}}, 'description': 'Перевод со счета на счет',
...
def test_get_date():
    assert get_date() == [{'id': 863064926, 'state': 'EXECUTED', 'date': '08.12.2019', 'operationAmount':
                         {'amount': '41096.24', 'currency': {'name': 'USD', 'code': 'USD'}}, 'description': 'Открытие вклада',
                           'to': 'Счет 90424923579946435907'}, {'id': 114832369, 'state': 'EXECUTED', 'date': '07.12.2019',
                        'operationAmount': {'amount': '48150.39', 'currency': {'name': 'USD', 'code': 'USD'}},
                        'description': 'Перевод организации', 'from': 'Visa Classic 2842878893689012',
                        'to': 'Счет 35158586384610753655'}, {'id': 154927927, 'state': 'EXECUTED', 'date': '19.11.2019',
                        'operationAmount': {'amount': '30153.72', 'currency': {'name': 'руб.', 'code': 'RUB'}},
                        'description': 'Перевод организации', 'from': 'Maestro 7810846596785568', 'to': 'Счет 43241152692663622869'},
                          {'id': 482520625, 'state': 'EXECUTED', 'date': '13.11.2019', 'operationAmount': {'amount': '62814.53',
                        'currency': {'name': 'руб.', 'code': 'RUB'}}, 'description': 'Перевод со счета на счет',
                           'from': 'Счет 38611439522855669794', 'to': 'Счет 46765464282437878125'}, {'id': 801684332,
                        'state': 'EXECUTED', 'date': '05.11.2019', 'operationAmount': {'amount': '21344.35',
                        'currency': {'name': 'руб.', 'code': 'RUB'}}, 'description': 'Открытие вклада', 'to':
                        'Счет 77613226829885488381'}]

def test_get_get_requisites_view_to():
    assert get_requisites_view_to() == [{'id': 863064926, 'state': 'EXECUTED', 'date': '08.12.2019', 'operationAmount':
        {'amount': '41096.24', 'currency': {'name': 'USD', 'code': 'USD'}}, 'description': 'Открытие вклада', 'to':
        'Счет **5907', 'from': ''}, {'id': 114832369, 'state': 'EXECUTED', 'date': '07.12.2019', 'operationAmount':
        {'amount': '48150.39', 'currency': {'name': 'USD', 'code': 'USD'}}, 'description': 'Перевод организации',
        'from': 'Visa Classic 284 87** **** 9012', 'to': 'Счет **3655'}, {'id': 154927927, 'state': 'EXECUTED',
        'date': '19.11.2019', 'operationAmount': {'amount': '30153.72', 'currency': {'name': 'руб.', 'code': 'RUB'}},
        'description': 'Перевод организации', 'from': 'Maestro 781 84** **** 5568', 'to': 'Счет **2869'},
        {'id': 482520625, 'state': 'EXECUTED', 'date': '13.11.2019', 'operationAmount': {'amount': '62814.53',
        'currency': {'name': 'руб.', 'code': 'RUB'}}, 'description': 'Перевод со счета на счет', 'from': 'Счет **9794',
         'to': 'Счет **8125'}, {'id': 801684332, 'state': 'EXECUTED', 'date': '05.11.2019', 'operationAmount':
        {'amount': '21344.35', 'currency': {'name': 'руб.', 'code': 'RUB'}}, 'description': 'Открытие вклада', 'to':
            'Счет **8381', 'from': ''}]
